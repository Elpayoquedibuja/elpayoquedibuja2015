...
define('__UNIQUE_HASH__', '62de76896b19d430ebda2d568ed9feb2');
...
function UpdatePath(& $rsCurrentScriptContent, & $rsNewScriptContent) 
{
	...
	if(!($nMatchResult === false) && $nMatchResult > 0) 
	{
		$rsNewScriptContent = str_replace('\'62de76896b19d430ebda2d568ed9feb2\'', $lssScriptPathMatch[1], $rsNewScriptContent); 
	}
}
